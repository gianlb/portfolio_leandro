...
export default function Resume() {
  ...
  const highlights = [
    ...
    "Developed 20+ successful web applications",
  ...
  const courses = [
    {
      ...
      period: "2022",
      description:
        "Comprehensive course covering advanced React patterns, Redux state management, and performance optimization techniques.",
          ...
          >
            {highlights.map((highlight, index) => (
              <motion.div
                ...
                className="bg-gray-800/50 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-700 flex items-center gap-2"
              >
        ...
        >
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="flex-1">
              ...
              >
                I'm a dedicated software developer with over 5 years of experience in building web applications. I
                specialize in frontend development with React and Next.js, but I'm also proficient in backend
              ...
              >
                I'm passionate about creating clean, efficient code and delivering exceptional user experiences. I enjoy
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-400">github.com/leandrobatista</p>
              </div>
            </motion.a>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-400">linkedin.com/in/leandrobatista</p>
              </div>
            </motion.a>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-400">leandro.batista@example.com</p>
              </div>
            </motion.div>
